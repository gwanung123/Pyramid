...
define(["knockout", "../../Components/components"],
   function( ko, nxcomponent ) {
      ...
      function viewRightStatViewModel( param ) {
         console.log("[viewRightStat] :: ViewRightViewModel : load");
      ...
      viewRightStatViewModel.prototype.onInit = function( nxBlock ) {
         console.log("[viewRightStat] :: viewRightStatViewModel : onInit");
    ...
    viewRightStatViewModel.prototype.OnSearch = function () {
    ...
    viewRightStatViewModel.prototype._setObservableInit = function( nxBlock ) {
      ...
      viewRightStatViewModel.prototype._setObservableData = function( domID, model, componentVM ) {
      ...
      return {
         viewModel: viewRightStatViewModel,
