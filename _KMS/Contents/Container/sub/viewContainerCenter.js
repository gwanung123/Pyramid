      ...
      ViewCenterViewModel.prototype._setJoinEvent = function( tag, join, component ) {
         ...
         self._joinEvent = {
            ...
            onCheck : function( tag, checked, methods, param ) {
               ...
               var subComponent = component.joinBind[tag];

               var joinBindVM = self._onJoinBind(component,
                                                 subComponent,
                                                 text[tag],
                                                 {
                                                    joinBind: subComponent
                                                 });

               joinBindVM._setJoinData(checked, tag);
