...
define(["../../../Library/report.dbms"],
   function( _DBMS ) {
      ...
      Grid.prototype.requestArgs = function( action, data, options ) {
         var self = this;
         var argsFields = $.extend(true, {}, options.nexus.dbms[action].ARGS),
             args = [],
             arr = [];
      ...
      Grid.prototype.setColumns = function( action, text, options ) {
         var self = this;
      ...
      Grid.prototype.getOptions = function( text, dbms ) {
         ...
         options.pdf = {
            allPages: true,
            fileName: text.FILENAME + ".pdf",
            author: "iPECS",
            date: new Date()
         };

         self.setColumns("SELECT_ALL", text, options);
