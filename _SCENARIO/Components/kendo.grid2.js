...
define(["./models/model.kendo.grid2", "kendo.all.min"],
   function( model ) {

      function KendoGrid2( tag, domID, options ) {
         console.log("[KendoGrid2] :: Grid : load");

         if ( options === null ) {
            console.log("[KendoGrid2] :: error > options is null");
            return null;
         }
         ...
         if ( this.param === null ) {
            console.log("[KendoGrid2] :: error > invalid options");
            return null;
         }
      ...
      KendoGrid2.prototype.onDestroy = function() {
         var self = this;
         self.grid.destroy();
         self.timerDestroy();
      };

      KendoGrid2.prototype.getData = function() {
         var self = this;
         return self.model.makeDataGet();
      };

      KendoGrid2.prototype.setDataSource = function( data, schema, sort ) {
         var self = this;
         ...
         var dataSource = new kendo.data.DataSource({
            ...
            transport: {
                  read: function( e ) {
                     console.log("[KendoGrid2] :: DataSource : read");
                     e.success(data);
                  }
            },
            schema: schema,
      ...
      KendoGrid2.prototype.setData = function( data, param ) {
         var self = this;
         var finalData = data || [],
             isChange = false;

         console.log("[KendoGrid2] :: Grid : setData: " + finalData.length);
      ...
      KendoGrid2.prototype.setDataDelete = function( data ) {
         console.log("[KendoGrid2] :: Grid : setDataDelete: "+data.length);
         var self = this;
      ...
      KendoGrid2.prototype.setPushData = function( action, service, id, data, bind ) {
         var self = this;
      ...
      KendoGrid2.prototype.setEvents = function( domID, options ) {
         var self = this;
         ...
         self.onBtnEdit = function( e ) {
            console.log("[KendoGrid2] :: Grid : onBtnEdit");
            //e.preventDefault();
         ...
         self.onBtnCancel = function( e ) {
            console.log("[KendoGrid2] :: Grid : onBtnCancel");
            isEditing = false;
            self.grid.cancelChanges();
         ...
         self.onBtnSave = function( e ) {
            console.log("[KendoGrid2] :: Grid : onBtnSave");
            isEditing = false;
         ...
         self.onBtnRemove = function( e ) {
            console.log("[KendoGrid2] :: Grid : onBtnRemove");
            //e.preventDefault();
            self.grid.cancelChanges();
         ...
         self.onNavigate = function( e ) {
            console.log("[KendoGrid2] :: Grid : onNavigate");
            if ( options.onNavigate !== undefined ) options.onNavigate(self.TAG, e, self);
         };

      };

      KendoGrid2.prototype.setCustomEvents = function( domID, options ) {
         var self = this;
      ...
      KendoGrid2.prototype.doMethods = function() {
         var self = this;
