...
(function () {
   ...
   requirejs.config({
      ...
      paths: {
         ...
         "nxdefine" : "scenario.define",
         "nxbinder" : "scenario.binder",
         "nxrouter" : "scenario.router",
         "nxmonitor": "scenario.monitor"
      },
      shim: {
         "kendo.all.min": {
            deps: ["jquery"]
   ...
   function(
      ...
      var main = function () {
         console.log("[scenario] :: main : start");
         init();
      };
