...
define([],
   function() {
      ...
      //20180420 Sam #22979
      ptt.makeDataMode = function( mode , callType) {
        switch ( mode ) {
           case "201": return "LOGIN";
           case "202": return "LOGOUT";
           case "203": return "NOT READY";
      ...
      ptt.makeData = function( arrData, bind, param ) {
         ...
         for ( var i=0; i<len; i++ ) {
            ...
            for ( var key in bind ) {
               var valKey = bind[key];
               //if ( valKey === "AGENT_MODE" ) obj[key] = self.makeDataMode(data[valKey]); // 20180420 Sam #22979
               if ( valKey === "AGENT_MODE" ) obj[key] = self.makeDataMode(data[valKey],data["CALL_TYPE"]);// 20180420 Sam #22979 
