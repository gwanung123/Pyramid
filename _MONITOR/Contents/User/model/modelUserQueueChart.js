...
define(["../../../Library/monitor.caching"],
   function( _caching ) {
       ...
       */
      QueueChart.prototype.getData = function( data ) {
      ...
      QueueChart.prototype.getPushData = function( data ) {
         var parsed = [];
      ...
      QueueChart.prototype.requestData = function( options, callback ) {
         var self = this;
      ...
      QueueChart.prototype.getOptions = function( text, nexus, shared ) {
         var self = this;
      ...
      QueueChart.prototype.setNexusJoin = function( name, cb, cbParam ) {
         var self = this;
