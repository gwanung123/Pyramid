...
(function () {
   ...
   requirejs.config({
      ...
      paths: {
         ...
         "nxdefine" : "campaign.define",
         "nxbinder" : "campaign.binder",
         "nxrouter" : "campaign.router",
         "nxmonitor": "campaign.monitor"
      },
      shim: {
         "kendo.all.min": {
            deps: ["jquery"]
   ...
   function(
      ...
      var main = function () {
         console.log("[campaign] :: main : start");
         init();
      };
