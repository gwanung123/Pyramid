...
define([
   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridQueueViewModel( win ) {

         console.log("[containerGridQueue] :: containerGridQueueViewModel : load");
         var self = this;
         ...
         require(["nxdefine"], function( _define ) {
            console.log("[containerGridQueue] :: containerGridQueueViewModel : define load");
            self._DEFINE = _define;
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_QUEUE.TAG;
               ...
               setPushData : function( action, service, id, data, bind ) {
                  ...
                  for ( var domID in it.handle ) {
                     ...
                     if ( component.type === "KENDO.GRID" ) {
                        ...
                        if ( component.tag === "QUEUE_CALL_GRID" && media_id >= 10 ) continue;
                        if ( component.tag === "QUEUE_UQ_GRID" && media_id < 10 ) continue;
      ...
      // prototype
      //===============================================================================//
      var _ptt = containerGridQueueViewModel.prototype;

      _ptt.onContentLoad = function() {
         console.log("[containerGridQueue] :: containerGridQueueViewModel : onContentLoad");
         var self = this;
      ...
      return containerGridQueueViewModel;
