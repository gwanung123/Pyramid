...
define(["./models/model.kendo.barchart", "kendo.all.min"],
   function( model ) {
      ...
      KendoBarchart.prototype.setPushData = function( action, id, data ) {
         var self = this;
      };

      KendoBarchart.prototype.setDataSource = function( data ) {
        // var self = this;
        ...
        // self.barchart.dataSource.data(dataSource);
