   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridAllViewModel( win ) {
         ...
         require(["nxdefine"], function( _define ) {
            ...
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_ALL_TRACE.TAG;
         ...
         this._setTemplates = {
            ...
            _viewTop : {
               ...
               customBind : function() {
                  ...
                  for ( var domID in it.handle ) {
                     ...
                     var template = "<div class=\"nx-day-search\">" +
                                    ...
                                    "<label class=\"nx-ani-title\"> ANI :  </label>" +
                                    "<input id=\"nx-ani\" style=\"width: 150px\"/>" +
                     ...
                     if ( component.type === "KENDO.GRID" ) {
                        ...
                        var aniNum = grid.find("#nx-ani").kendoMaskedTextBox({mask:"000000000000"});
               ...
               requestData : function( startDay, endDay, ani ) {
                  var it = this;
      ...
      _ptt._setEvent = function( tag, options ) {
         ...
         self._meEvent = {
            onSearch: function( start, end, domID, components ) {
               ...
               self._setTemplates._viewBottom.requestData(startDay, endDay);
            },
