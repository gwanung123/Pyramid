...
define(["knockout", "../../../Components/components", "../../../ComponentTmpls/componentTmpls"],
   function( ko, _nxcomponent, _nxcomponentTmpl ) {
      ...
      ViewRightViewModel.prototype.onTemplatesLoad = function( nxWinID, nxBlock, nxWindow, parent ) {
         var self = this;
      ...
      ViewRightViewModel.prototype._setObservableData = function( domID, m, vm, options ) {
         var self = this;
