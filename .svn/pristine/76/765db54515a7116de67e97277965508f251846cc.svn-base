...
define(['sammy', "nxbinder", "nxdefine", "Defines/text.define", "Components/components"],
   function( _SAMMY, _BINDER, _DEFINE, _TEXT, _Components ) {
      ...
      var changeURL = function( tag ) {
         ...
         if ( change === undefined ) {
            console.log("[campaign.router] :: sammy : changeURL = "+tag);
            return;
         }
      ...
      var _init = {
         ...
         pusher: function() {
            var that = this;
            var pushParams = _nxPusher.getParams(pushParams, "TREEVIEW_CAMPAIGN", "master");

            pushParams = _nxPusher.getParams(pushParams, "TREEVIEW_CAMPAIGN", "campaign");
      ...
      var application = _SAMMY(function() {
         ...
         this.get("campaign.html", function(context) {
            console.log("[campaign.router] :: sammy : application = "+application.getLocation());
