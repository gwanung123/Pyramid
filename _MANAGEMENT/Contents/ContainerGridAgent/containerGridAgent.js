...
define([
   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridAgentViewModel( win ) {

         console.log("[containerGridAgent] :: containerGridAgentViewModel : load");
         var self = this;
         ...
         require(["nxdefine"], function( _define ) {
            console.log("[containerGridAgent] :: containerGridAgentViewModel : define load");
            self._DEFINE = _define;
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_AGENT.TAG;
               ...
               setPushData : function( action, service, id, data, bind ) {
                  ...
                  for ( var domID in it.handle ) {
                     ...
                     if ( component.type === "KENDO.GRID" ) {
                        ...
                        if ( component.tag === "AGENT_CALL_GRID" && media_id >= 10 ) continue;
                        if ( component.tag === "AGENT_UQ_GRID" && media_id < 10 ) continue;
      ...
      // prototype
      //===============================================================================//
      var _ptt = containerGridAgentViewModel.prototype;

      _ptt.onContentLoad = function() {
         console.log("[containerGridAgent] :: containerGridAgentViewModel : onContentLoad");
         var self = this;
      ...
      return containerGridAgentViewModel;
