...
define([],
   function() {
       ...
       */
      TeamTreeview.prototype.getData = function( arrData ) {
      ...
      TeamTreeview.prototype.getPushData = function( data ) {
         return data.DATA;
      };

      TeamTreeview.prototype.requestDepth1 = function( bind, self ) {
      ...
      TeamTreeview.prototype.requestDepth2 = function( bind, self ) {
      ...
      TeamTreeview.prototype.requestDepth3 = function( bind, self ) {
      ...
      TeamTreeview.prototype.requestDepth4 = function( bind, self ) {
      ...
      TeamTreeview.prototype.requestData = function( options, callback ) {
         var self = this;
      ...
      TeamTreeview.prototype.getOptions = function( text, nexus, shared, dbms ) {
         var self = this;
      ...
      TeamTreeview.prototype.setNexusJoin = function( name, cb, cbParam ) {
         var self = this;
