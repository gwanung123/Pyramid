...
define([
   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridSubAgentViewModel( win ) {

         console.log("[containerGridSubAgent] :: containerGridSubAgentViewModel : load");
         var self = this;
         ...
         require(["nxdefine"], function( _define ) {
            console.log("[containerGridSubAgent] :: containerGridSubAgentViewModel : define load");
            self._DEFINE = _define;
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_SUBAGENT.TAG;
      ...
      // prototype
      //===============================================================================//
      var _ptt = containerGridSubAgentViewModel.prototype;

      _ptt.onContentLoad = function() {
         console.log("[containerGridSubAgent] :: containerGridSubAgentViewModel : onContentLoad");
         var self = this;
      ...
      return containerGridSubAgentViewModel;
