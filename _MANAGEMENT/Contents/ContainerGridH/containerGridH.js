...
define([
   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridHViewModel( win ) {

         console.log("[containerGridH] :: containerGridHViewModel : load");
         var self = this;
         ...
         require(["nxdefine"], function( _define ) {
            console.log("[containerGridH] :: containerGridHViewModel : define load");
            self._DEFINE = _define;
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_H.TAG;
         ...
         this._setTemplates = {
            init : function() {
               var that = this;
               var splitterCss = "nx-containerGridH-splitter",
               ...
               setTimeout( function() {
                  _Components.onComponentLoad(self._ROOT, "KENDO.SPLITTER", splitterID, {
                     ...
                     panes: [
                        { collapsible: true, collapsedSize: "4%", size: "87%", min: "87%", max: "87%" },
                        {}
                     ]
                  });
               }, 100 );

               that._viewTop.init(splitterID);
               that._viewBottom.init(splitterID);
            },
            _viewTop : {
               handle : undefined,
               init : function( parentID ) {
                  ...
                  var dbms = self._dbms[win.others.joinBind["viewTop"].dbms],
                      ...
                      title = win.others.joinBind["viewTop"].title,
                      defineBlock = self._setObservable("viewTop");
                  var html = "<h5 class=\"nx-containerGridH-title\">" + title + "</h5>",
            ...
            _viewBottom : {
               ...
               init : function( parentID ) {
                  ...
                  var dbms = self._dbms[win.others.joinBind["viewBottom"].dbms],
                      ...
                      title = win.others.joinBind["viewBottom"].title,
      ...
      // prototype
      //===============================================================================//
      var _ptt = containerGridHViewModel.prototype;

      _ptt.onContentLoad = function() {
         console.log("[containerGridH] :: containerGridHViewModel : onContentLoad");
         var self = this;
      ...
      _ptt._getHandleAfterBind = function( dbms, text, me ) {
         ...
         for ( var idx=0; idx<me.components.length; idx++ ) {
            ...
            if ( component.model !== undefined ) {
               ...
               options = componentM.getOptions(text, dbms);
      ...
      return containerGridHViewModel;
