...
define([
   ...
   function( _binder, _TEXT, _Components ) {
      ...
      function containerGridLoginIdViewModel( win ) {

         console.log("[containerGridLoginId] :: containerGridLoginIdViewModel : load");
         var self = this;
         ...
         require(["nxdefine"], function( _define ) {
            console.log("[containerGridLoginId] :: containerGridLoginIdViewModel : define load");
            self._DEFINE = _define;
            self._ROOT = self._DEFINE.MENU.CONTAINER_GRID_LOGINID.TAG;
               ...
               setPushData : function( action, service, id, data, bind ) {
                  ...
                  for ( var domID in it.handle ) {
                     ...
                     if ( component.type === "KENDO.GRID" ) {
                        ...
                        if ( component.tag === "LOGINID_CALL_GRID" && media_id >= 10 ) continue;
                        if ( component.tag === "LOGINID_UQ_GRID" && media_id < 10 ) continue;
      ...
      // prototype
      //===============================================================================//
      var _ptt = containerGridLoginIdViewModel.prototype;

      _ptt.onContentLoad = function() {
         console.log("[containerGridLoginId] :: containerGridLoginIdViewModel : onContentLoad");
         var self = this;
      ...
      return containerGridLoginIdViewModel;
