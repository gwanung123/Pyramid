...
define(["../../../Library/campaign.dbms"],
   function( _DBMS ) {
       ...
       * CAMPAIGN TREEVIEW
       *********************************************************************************/
      var CampaignTreeview = function( tag ) {
         this.tag = tag;
       ...
       */
      CampaignTreeview.prototype.getData = function( arrData ) {
      ...
      CampaignTreeview.prototype.getPushData = function( data ) {
         return data.DATA;
      };

      CampaignTreeview.prototype.requestDepth1 = function( bind, self ) {
      ...
      CampaignTreeview.prototype.requestDepth2 = function( bind, self ) {
         var deferred = $.Deferred();
      ...
      CampaignTreeview.prototype.requestData = function( options, callback ) {
         var self = this;
      ...
      CampaignTreeview.prototype.getOptions = function( text, nexus, shared, dbms ) {
         var self = this;
      ...
      CampaignTreeview.prototype.setNexusJoin = function( name, cb, cbParam ) {
         var self = this;
       ...
       ************************************************************************************/
      return function( tag ) {
         return new CampaignTreeview(tag);
      };
