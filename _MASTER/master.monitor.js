...
define(["Library/master.monitoring", "nxws"],
   function( _monitoring ) {

      /*********************************************************************************
       * Master Push
       *********************************************************************************/
      var MasterPush = function() {
      ...
      ****************************************************************************/
      ...
      ptt.onOpen = function() {
         console.log("## MasterPush >> onOpen");
      };

      ptt.onClose = function() {
         console.log("## MasterPush >> onClose");
      };

      ptt.onError = function( error ) {
         console.log("## MasterPush >> onError => "+error);
      };

      ptt.onMessage = function( data ) {
         var self = this;
         console.log("## MasterPush >> onMessage => "+JSON.stringify(data));
      ...
      ptt.doClose = function() {
         var self = this;
         console.log("## MasterPush >> doClose");
      ...
      ptt.doSend = function( data ) {
         ...
         console.log("## MasterPush >> doSend :: "+strData);
