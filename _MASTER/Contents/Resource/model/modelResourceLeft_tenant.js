...
define([],
   function() {
       ...
       * TENANT TREEVIEW
       *********************************************************************************/
      var TenantTreeview = function( tag ) {
         this.tag = tag;
       ...
       */
      TenantTreeview.prototype.getData = function( arrData ) {
      ...
      TenantTreeview.prototype.getPushData = function( data ) {
         return data.DATA;
      };

      TenantTreeview.prototype.requestDepth1 = function( bind, self ) {
      ...
      TenantTreeview.prototype.requestDepth2 = function( bind, self ) {
      ...
      TenantTreeview.prototype.requestData = function( options, callback ) {
         var self = this;
      ...
      TenantTreeview.prototype.getOptions = function( text, nexus, shared, dbms ) {
         var self = this;
      ...
      TenantTreeview.prototype.setNexusJoin = function( name, cb, cbParam ) {
         var self = this;
